...
break
case 'jadikatalog': case 'dimkatalog': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
//=================================================//
case 'dimtroli2': case 'dimtrol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
//=================================================//
case 'dimvirtext1': case 'dimzsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'dimvirtext2': case 'tol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'dimvirtext3': case 'memek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'dimvirtext4': case 'contol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'dimvirtext5': case 'dimtextv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'dimvirtext6': case 'dimgas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'dimvirtext7': case 'dimvirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'dimvirtext8': case 'dimvirtext1': case 'crashar7':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'dimvirtext9': case 'dimvirtext2': case 'crashar8':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'dimvirtext10': case 'dimvirtext3': case 'crashar9': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dimbug1': case 'dimcrash': case 'crashar10':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dimbug2': case 'dimcrash1': case 'crashar11': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dimbug3': case 'dimcrash2': case 'crashar12': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dimbug4': case 'dimcrash3': case 'crashar13':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dimbug5': case 'dimcrash4': case 'crashar14': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case 'dimbug6': case 'dimcrash5': case 'crashar15':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dimbug7': case 'dimcrash6': case 'crashar16':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'dimbug8': case 'dimcrash7': case 'crashar17': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case '🌷': case 'crashmek': case 'ampunsuhu': case 'ahyangdimul': case 'okemek': case 'dimnih': case 'crashar18': case 'mexdemam': case 'dim1': case 'dim2': case 'dim3': case 'dim4': case 'dim5': case 'dim6': case 'dim7': case 'dim8': case 'dim9': case 'dim10': case 'dim11': case 'dim12': case 'dim13': case 'dim14': case 'dim15': case 'dim16': case 'dim17': case 'dim18': case 'dim19': case 'dim20': case 'dim21': case 'dim22': case 'dim23': case 'dim24': case 'dim25': case 'dim26': case 'dim27': case 'dim28':
case 'dim29':
case 'dim30':
case 'dim31':
case 'dim32':
...
break
//=================================================//
case 'stik': case 'dimkangbug': case 'buttonkematian': case 'crashar19': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'dimbugie': case 'dimkangbug1': case 'crashar20': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'button': case 'dimkangbuttton': case 'testbutton': case 'inibutton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
const apa = ['Iya', 'Tidak', 'Bisa Jadi', 'dimul']
...
│⿻ afk ( Kasih Reactions ) 
╠⿻ dimghoib ( ON / OFF ) 
│⿻ dimjagoan ( Reply Target ) 
╠⿻ dimsange ( Harus Menjadi Admin ) 
│⿻ bugtiktok ( Link ) - Bug Sw
╠⿻ 🔥 628xxx|5|5
│⿻ crashmex 628xxx|5|5
╠⿻ dimskuy 628xxx
│⿻ dimsantet 628xxx@s.whatsapp.net|10|10s
╠⿻ Catalogpc 628xxx@s.whatsapp.net|10|10s
│⿻ AnjayAlok ( jumblah ) 
╠⿻ 𝐠𝐚𝐬dim 112674448xxx
│⿻ dim𝐬𝐚𝐧𝐭𝐞𝐭𝐠𝐜  1237891xxxx@g.us|10|10s
